...
export const RoadClassChart = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const response = await fetchCollisionsByRoadClass();
    ...
    return (
        <CategoryBarCard
            ...
            subtitle="Collisions by Road Class"
